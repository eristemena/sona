...
> **NOTE: Write these tests FIRST when the story changes data, scheduling, derivation, import/export, or audio behavior. Ensure they FAIL before implementation.**
...
- [ ] TXXX [P] Additional unit tests for uncovered logic in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Validate offline startup and no-account operation
- [ ] TXXX Validate migration, backup, or export safety for learner data
- [ ] TXXX Validate review-load caps and backlog recovery behavior
