...
export function SidebarNavItem({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex h-10 w-full items-center justify-between rounded-md border border-transparent px-4 text-left text-[14px] font-medium transition-all duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--accent)",
        active
