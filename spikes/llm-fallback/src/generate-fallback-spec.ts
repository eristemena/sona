...
export async function generateFallbackSpec(options: GenerateFallbackSpecOptions = {}) {
  const policies = [
    createProviderFallbackPolicy({
      id: 'annotation-help-online',
      featureArea: 'annotation-help',
      providerType: 'openai',
      eligibilityRule: 'Use only when the learner requests inline annotation help and credentials are configured.',
      ...
      failureBehavior: 'Return to local-only annotation flow with a visible degraded state.',
    }),
    createProviderFallbackPolicy({
      id: 'translation-help-online',
      featureArea: 'translation-help',
      providerType: 'anthropic',
      eligibilityRule: 'Use only when the learner opts into translation support and credentials are configured.',
      ...
      failureBehavior: 'Fallback to text-only study with no blocked progression.',
    }),
    createProviderFallbackPolicy({
      id: 'tts-online',
      featureArea: 'tts',
      providerType: 'google-cloud-tts',
      eligibilityRule: 'Use only for optional audio generation when the learner requests pronunciation support.',
      ...
      failureBehavior: 'Mark audio unavailable and continue with reading and review continuity.',
    }),
  ]
